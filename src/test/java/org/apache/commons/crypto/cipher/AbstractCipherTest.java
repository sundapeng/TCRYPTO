...
public abstract class AbstractCipherTest {
    ...
    public static final String OPENSSL_CIPHER_CLASSNAME = CryptoCipherFactory
        .CipherProvider.OPENSSL.getClassName();

    public static final String JCE_CIPHER_CLASSNAME = CryptoCipherFactory
    ...
    public void reInitTest() throws Exception {
        ...
        enc.init(
            Cipher.ENCRYPT_MODE, new SecretKeySpec(KEY, "AES"), new IvParameterSpec(IV));
        enc.init(
            Cipher.DECRYPT_MODE, new SecretKeySpec(KEY, "AES"), new IvParameterSpec(IV));
        enc.init(
            Cipher.ENCRYPT_MODE, new SecretKeySpec(KEY, "AES"), new IvParameterSpec(IV));
        enc.close();
    }
